                      ...
                      <div className="space-y-4 flex flex-col items-center lg:items-start">
                        ...
                        >
                          ...
                          <div className="text-center lg:text-left flex-1">
                            ...
                            <div className="text-base lg:text-lg text-blue-600 font-semibold">Most popular • Connect in 30 seconds</div>
                          </div>
                          <div className="text-blue-500 group-hover:translate-x-1 transition-transform hidden lg:block">
                        ...
                        >
                          ...
                          <div className="text-center lg:text-left flex-1">
                            ...
                            <div className="text-base lg:text-lg text-orange-600 font-semibold">Enterprise • Instant connection</div>
                          </div>
                          <div className="text-orange-500 group-hover:translate-x-1 transition-transform hidden lg:block">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                          </div>
