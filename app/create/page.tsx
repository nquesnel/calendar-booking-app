          ...
          {!showSuccess ? (
            ...
            <div className="text-center">
              ...
              <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-blue-700 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
                  <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
                    
                    {/* LEFT COLUMN - CONNECTION HERO (60% width) */}
                    <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="space-y-6">
                        <button
                          ...
                          className="group w-full max-w-md mx-auto lg:mx-0 bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center space-x-4 border-2 border-blue-500"
                          style={{boxShadow: '0 10px 30px rgba(66,133,244,0.2)'}}
                        >
                          ...
                          <div className="text-left flex-1">
                            <div className="text-lg font-bold text-slate-900">Google Calendar</div>
                        ...
                        <button
                          ...
                          className="group w-full max-w-md mx-auto lg:mx-0 bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center space-x-4 border-2 border-orange-500"
                          style={{boxShadow: '0 10px 30px rgba(0,120,212,0.2)'}}
                        >
                          <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                          ...
                          <div className="text-left flex-1">
                            <div className="text-lg font-bold text-slate-900">Microsoft Outlook</div>
                            <div className="text-sm text-orange-600 font-medium">Enterprise • Instant connection</div>
                          </div>
                        </button>
                      </div>
                    ...
                    {/* RIGHT COLUMN - EXCITEMENT & PREVIEW (40% width) */}
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center space-x-3 text-white text-opacity-90">
                            ...
                            <span className="font-medium">AI finds perfect mutual times instantly</span>
                          </div>
                          <div className="flex items-center space-x-3 text-white text-opacity-90">
                            <span className="text-xl">⚡</span>
                            <span className="font-medium">Your recipient books in under 2 minutes</span>
                          </div>
                          <div className="flex items-center space-x-3 text-white text-opacity-90">
                            <span className="text-xl">🎯</span>
                            <span className="font-medium">Zero back-and-forth emails ever again</span>
                          </div>
                        </div>
                      </div>

                      {/* Meeting Preview Card with AI Badge */}
                      <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-20">
                        ...
                        <div className="absolute -top-3 -right-3">
                          <div className="bg-gradient-to-r from-pink-500 to-yellow-400 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                            ✨ AI-Powered
                          </div>
                        </div>
                        
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-lg font-semibold text-white">Meeting Preview</h3>
                          <button
                            onClick={() => setShowEditModal(true)}
                            className="text-white hover:text-yellow-300 p-2 rounded-lg hover:bg-white hover:bg-opacity-10 transition-all"
                          >
                        ...
                        <div className="space-y-2 text-sm text-white text-opacity-90">
                          <div><strong className="text-white">To:</strong> {formData.inviteeEmail}</div>
                          <div><strong className="text-white">Title:</strong> {formData.meetingTitle}</div>
                          <div><strong className="text-white">Duration:</strong> {formData.duration} minutes</div>
                          <div><strong className="text-white">Type:</strong> {formData.meetingType.charAt(0).toUpperCase() + formData.meetingType.slice(1)}</div>
                          {formData.meetingType === 'video' && (
                            <div><strong className="text-white">Link:</strong> {formData.meetingLink || 'To be provided'}</div>
                          )}
                          {formData.meetingType === 'phone' && (
                            <div><strong className="text-white">Phone:</strong> {formData.phoneNumber || 'To be provided'}</div>
                          )}
                          {formData.meetingType === 'in-person' && (
                            <div><strong className="text-white">Location:</strong> {formData.address || 'To be provided'}</div>
                          )}
                          {formData.meetingType === 'custom' && (
                            <div><strong className="text-white">Details:</strong> {formData.meetingNotes || 'To be provided'}</div>
                          )}
                        </div>
                      </div>
                    </div>
